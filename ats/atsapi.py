...
class DMABuffer:
    ...
    '''
    def __init__(self, cSampleType, size_bytes):
...
class DspModule:
    ...
    ats.AlazarFFTSetup.argtypes = [U32, U32, U16, U32, U32, U32, U32, U32, c_void_p]
    ats.AlazarFFTSetup.errcheck = returnCodeCheck
    def fftSetup(self, enable, inputChannelMask, recordLength_samples,
