...
cavity_source = SGMA(rm.open_resource(config.rfsource_ip))
lo_source = SGMA(rm.open_resource(config.rfsource2_ip))
qubit_source = SGMA(rm.open_resource(config.rfsource3_ip))
